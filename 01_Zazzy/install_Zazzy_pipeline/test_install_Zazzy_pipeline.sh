...
conda create -n zazzy_metbarcoding_pipeline -c bioconda -c conda-forge cutadapt=2.7 itsx ucsc-fasplit vsearch=2.14.0 --yes # new cutadapt version requires different script
conda init bash
